...
import type { MemberActionRow } from "@/lib/data/campaigns";
import { completeMemberActionAction } from "./cta-actions";
          ...
          >
            ...
            <div className="mt-3 flex items-center justify-end gap-2">
              ...
              {a.completed ? (
                ...
                <form
                  action={completeMemberActionAction}
                  onSubmit={() => {
