      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-12">
        {!isSignedIn && (
          <PreviewSignupBanner
            ...
            body="Logged-out preview banners never showed a real balance (and high sample numbers were misleading). Nellie's Jackie launch: free dessert with entrée on join, 1,500 bonus points after 3 visits, birthday entrée up to $30. Bourbon & Cigar Night — September 23, 7:00 PM ET."
            bullets={[
