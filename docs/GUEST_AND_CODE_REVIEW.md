...
4. **Jackie launch perks** — free dessert with entrée **on join**; **1,500** bonus points after **3 verified check-ins**; birthday entrée up to $30 **in birthday month**. Bourbon & Cigar Night: **September 23, 2026, 7:00 PM ET**, Private Dining Room (not Rooftop). Apron / hot sauce merch **hidden**. Do not market 1-pt catalog SKUs.
...
- Soft-launch catalog: Jackie join / 3-visit / birthday rules + Bourbon Sept 23 (Private Dining Room). Apron/hot sauce hidden.
