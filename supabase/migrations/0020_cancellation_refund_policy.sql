...
insert into public.policy_pages (slug, title, content_md, is_draft) values
  ('cancellation_refund', 'Cancellation & Refund Policy',
   ...
   E'## 1. Subscription cancellation\nYou may cancel your Brand Engage Pro subscription at any time via your account settings or by contacting support@memberengage.app.\n\n' ||
   ...
   E'## 4. Contact\nTo request a refund or to discuss your cancellation, please email support@memberengage.app with your account email and the reason for your request.\n\n' ||
   E'Disputes or escalations may be sent to legal@memberengage.app.',
   true)
